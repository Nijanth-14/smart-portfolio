  ...
  return (
    <div className="relative min-h-screen overflow-hidden pb-24 pt-24">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-5 sm:px-6">
        <section className="gradient-border glass rounded-[2rem] p-7 sm:p-10 mt-10 reveal-up overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row items-center md:items-end gap-7">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <h1 className="text-4xl sm:text-6xl font-black tracking-[-.05em] text-electric">{profile.full_name}</h1>
          ...
          <div className="lg:col-span-2">
            <PortfolioCard title="Featured repositories" icon={<GitBranch className="w-5 h-5" />} className="h-full">
              <div className="grid sm:grid-cols-2 gap-4">
                {repos.map((repo: any) => (
                  <a key={repo.id} href={repo.html_url} target="_blank" rel="noopener noreferrer" className="group gradient-border glass rounded-2xl p-5 card-lift">
